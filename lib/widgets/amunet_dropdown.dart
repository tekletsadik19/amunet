...
class FenoteDropDown extends StatefulWidget {
  const FenoteDropDown({
    this.initialOption,
    this.hintText,
  ...
  @override
  State<FenoteDropDown> createState() => _FenoteDropDown();
}

class _FenoteDropDown extends State<FenoteDropDown> {
