...
part of 'finish_setting_profile_state.dart';
...
/// @nodoc
abstract class $FinishProfileStateCopyWith<T, $Res> {
  factory $FinishProfileStateCopyWith(FinishProfileState<T> value,
          $Res Function(FinishProfileState<T>) then) =
      _$FinishProfileStateCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$FinishProfileStateCopyWithImpl<T, $Res>
    implements $FinishProfileStateCopyWith<T, $Res> {
  _$FinishProfileStateCopyWithImpl(this._value, this._then);

  final FinishProfileState<T> _value;
  // ignore: unused_field
  final $Res Function(FinishProfileState<T>) _then;
}
...
class __$$_DataCopyWithImpl<T, $Res>
    extends _$FinishProfileStateCopyWithImpl<T, $Res>
...
class _$_Data<T> implements _Data<T> {
  ...
  @override
  String toString() {
    return 'FinishProfileState<$T>.data(user: $user)';
  }
...
abstract class _Data<T> implements FinishProfileState<T> {
...
class _$_Loading<T> implements _Loading<T> {
  ...
  @override
  String toString() {
    return 'FinishProfileState<$T>.loading()';
  }
...
abstract class _Loading<T> implements FinishProfileState<T> {
...
class _$_Error<T> implements _Error<T> {
  ...
  @override
  String toString() {
    return 'FinishProfileState<$T>.error(e: $e, stk: $stk)';
  }
...
abstract class _Error<T> implements FinishProfileState<T> {
